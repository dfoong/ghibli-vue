...
<p>
This project is built on the following:<br>
<a href="https://ghibliapi.herokuapp.com/" target="_blank">+ Studio Ghibli API</a><br>
<a href="https://www.taniarascia.com/how-to-connect-to-an-api-with-javascript/" target="_blank">+ Tutorial by Tania Rascia</a><br>
+ Many hours of patience from my kind professor, Becky<br>
= this capstone project for WATS4030<br>
</p>
<p>
<b>About Me</b><br>
